    ...
    <PageLayout title="About Us">
      ...
      <section className="bg-[#0B1520] py-14 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <motion.div {...fadeUp} className="max-w-3xl">
            <p className="text-primary text-sm font-bold tracking-[0.15em] uppercase mb-3 md:mb-4">Our Story</p>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <motion.div {...fadeUp} className="relative">
              <div className="absolute -top-3 -left-3 md:-top-4 md:-left-4 w-12 h-12 md:w-16 md:h-16 border-t-2 border-l-2 border-primary z-10" />
              <div className="relative overflow-hidden shadow-2xl aspect-[4/3] rounded bg-secondary">
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8">
                  <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 md:p-6 rounded text-white shadow-lg">
                    <p className="font-semibold text-base md:text-lg mb-1">World Trade Centre</p>
            ...
            >
              <p className="text-primary text-sm font-bold tracking-[0.1em] uppercase mb-3">Who We Are</p>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 md:mb-8 leading-[1.1] tracking-tight">
                Engineering Reliability for India's Fastest Growing Enterprises
              </h2>
              <div className="space-y-4 md:space-y-5 text-base md:text-lg text-muted-foreground font-light leading-relaxed">
                <p>
                ...
                <blockquote className="pl-5 md:pl-6 border-l-2 border-primary text-secondary font-medium text-lg md:text-xl my-5 md:my-6">
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-10 pt-7 md:pt-8 border-t border-gray-200">
                {[
                  { value: "500+", label: "Corporate Clients", icon: Users },
                  { value: "28+", label: "States Covered", icon: MapPin },
                  { value: "6+", label: "Years Expertise", icon: Award },
                ].map((s, i) => {
                  const Icon = s.icon;
                  return (
                    <div key={i} className="flex flex-col">
                      <Icon size={18} className="text-primary mb-2" />
                      <span className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">{s.value}</span>
                      <span className="text-[10px] md:text-xs font-semibold text-muted-foreground uppercase tracking-widest mt-1">{s.label}</span>
                    </div>
                  );
                })}
              </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto mb-10 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight">Our Mission & Vision</h2>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-4xl mx-auto">
            <motion.div
              {...fadeUp}
              className="bg-[#FAFAF8] p-7 md:p-10 rounded border border-gray-100 relative overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-1 h-full bg-primary" />
              <Target className="text-primary mb-4 md:mb-5" size={26} />
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-3 md:mb-4">Mission</h3>
            ...
            <motion.div
              ...
              viewport={{ once: true, margin: "-60px" }}
              transition={{ duration: 0.6, delay: 0.15, ease: [0.25, 0.1, 0.25, 1] }}
              className="bg-[#0B1520] p-7 md:p-10 rounded relative overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-1 h-full bg-primary" />
              <TrendingUp className="text-primary mb-4 md:mb-5" size={26} />
              <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4">Vision</h3>
      ...
      <section className="py-16 md:py-24 bg-[#FAFAF8]">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto mb-10 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight">Built Year by Year</h2>
          </motion.div>
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="space-y-7 md:space-y-10">
              {milestones.map((m, i) => (
                ...
                >
                  <div className="shrink-0 w-14 h-14 md:w-16 md:h-16 rounded bg-primary text-white flex items-center justify-center text-xs md:text-sm font-bold relative z-10">
                    {m.year}
                  </div>
                  <div className="pt-2 md:pt-3">
                    <h3 className="text-lg md:text-xl font-bold text-foreground mb-1.5 md:mb-2">{m.title}</h3>
                    <p className="text-muted-foreground font-light leading-relaxed text-sm md:text-base">{m.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-16 md:py-24 bg-[#0B1520]">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto mb-10 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">Our Core Values</h2>
          </motion.div>
            ...
            {values.map((v, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/5 border border-white/10 p-6 md:p-8 rounded hover:border-primary/40 transition-colors group"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded bg-primary/10 flex items-center justify-center mb-4 md:mb-5 group-hover:bg-primary/20 transition-colors">
                    <Icon className="text-primary" size={20} />
                  </div>
                  <h3 className="text-base md:text-lg font-bold text-white mb-2 md:mb-3">{v.title}</h3>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto mb-10 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight">Our Functional Pillars</h2>
            ...
            {leadership.map((l, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#FAFAF8] border border-gray-100 p-7 md:p-10 rounded text-center"
                >
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground mb-3 md:mb-4">{l.name}</h3>
      ...
      <section className="py-14 md:py-20 bg-[#FAFAF8] border-t border-gray-100">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <motion.div {...fadeUp}>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3 md:mb-4">Ready to Partner with WRHWFOUR?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/#services"
                className="w-full sm:w-auto px-7 md:px-8 py-4 border border-gray-300 text-foreground rounded font-medium hover:border-primary hover:text-primary transition-colors inline-block text-center"
              >
                View Our Services
              </a>
            </div>
