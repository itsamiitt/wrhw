...
export default function Coverage() {
  return (
    <section id="coverage" className="py-20 md:py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            <h2 className="text-sm font-bold tracking-[0.1em] text-primary uppercase mb-3">Service Area</h2>
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 md:mb-8 leading-[1.1] tracking-tight">
              Pan-India Coverage, <br className="hidden sm:block" />Centrally Managed
            </h3>
            <p className="text-base md:text-lg text-muted-foreground mb-8 md:mb-10 leading-relaxed font-light">
            ...
            <div className="flex items-center gap-4 md:gap-5 p-5 md:p-6 bg-[#FAFAF8] border border-gray-100 rounded-xl shadow-sm">
              <div className="bg-white p-3 md:p-4 rounded-full text-primary shrink-0 shadow-sm border border-gray-100">
                <MapPin className="w-6 h-6 md:w-8 md:h-8" />
              </div>
              <div>
                <p className="font-bold text-foreground text-base md:text-xl mb-1 tracking-tight">HQ: World Trade Centre, Pune</p>
                <p className="text-xs md:text-sm text-muted-foreground uppercase tracking-widest font-semibold">Serving Tier 1, 2, and 3 cities nationwide</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="lg:w-1/2 w-full relative aspect-square max-w-sm sm:max-w-md mx-auto lg:max-w-none"
          >
            ...
            <motion.div
              ...
              className="absolute bottom-0 right-0 bg-slate-900 p-6 md:p-8 shadow-2xl rounded-xl border-t-4 border-primary z-30"
            >
              <p className="text-4xl md:text-5xl font-bold text-white mb-2 tracking-tight">28<span className="text-primary">+</span></p>
              <p className="text-xs md:text-sm font-bold text-slate-400 uppercase tracking-widest">States Covered</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
