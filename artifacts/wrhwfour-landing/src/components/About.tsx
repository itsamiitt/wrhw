    ...
    <section id="about" className="py-32 bg-[#FAFAF8] overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative overflow-hidden shadow-2xl aspect-[4/3] rounded bg-secondary">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded text-white shadow-lg">
                  <p className="font-semibold text-lg mb-1 tracking-wide">World Trade Centre</p>
          ...
          >
            <h2 className="text-sm font-bold tracking-[0.1em] text-primary uppercase mb-4">Corporate Identity</h2>
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-10 leading-relaxed font-light">
              <p>
              ...
              <blockquote className="pl-6 border-l-2 border-primary text-secondary font-medium text-xl my-8">
            ...
            {/* Horizontal Stats */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12 py-8 border-y border-gray-200">
              {stats.map((stat, idx) => {
